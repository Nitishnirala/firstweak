...
public class SudokuSolver {
	static int row, col, nines = 0, left = 0, gnxt = 0, count = 0, filled = 1,
			dispnm = 0, nosolve = 0, colcount = 0, totalfilled = 0, rf, cf, h,
			smcnt = 0, nm, ur, uc, mn;
	static int a[][] = new int[9][9], b[][] = new int[9][9],
			posnum[][] = new int[9][9], poss[][][] = new int[9][9][9];
	static int single[] = new int[81];
	static boolean done = true, result = false;
	static int newa[][] = { { 0, 7, 0, 6, 0, 0, 1, 0, 0 },
...

	{
		...
		int check = 0, count2 = 0, fill = 0, r = 0, c = 0, cl = 0, rw = 0;

		boolean cond = false, result = false;
...

	{
		...
		for (row = 0; row < 9; row++) // STORING CANDIDATE DIGITS

		{
			for (col = 0; col < 9; col++) // IN 3-D ARRAY,THE

			{
				ht = 0; // 1st 2 DIMENSIONS REPRESENTING

				if (newa[row][col] == 0) // EACH BLOCK.
		...
		for (rf = 0; rf < 9; rf++) // CONVERTING ALL CANDIDATE * NUMBER

		{
			for (cf = 0; cf < 9; cf++) // DIGITS OF EACH BLOCK

			{
				p = 0;
				num = 0; // INTO CORRESPONDING

				for (h = 0; h < 9; h++) // NUMBER.
	...
	{
		int n, ht, s = 0, num, p, newcf = 0, samecand = 1, posnm = 0, rh, d = 0, mmc, drh;
...

		{
...

			{
...

				{
					...
					if (posnum[mr][mc] == posnum[mr][mmc]) // IF CANDIDATE
															// DIGITS ARE SAME
															// IN SAME COLUMN,
	...
	static void solveleminatecol()

	{
		int n, ht, s = 0, num, p, newcf = 0, samecand = 1, posnm = 0, rh, d = 0, mmr, drh;
	...
	static void boxeleminate()

	{
		int box, ri = 0, ci, rri, cci = 0, samecand = 1, posnm = 0, s = 0, rt = 0, ct, rh, drh, ht, n, num, newcf, p, kc = 0, kr = 0, kct, kci, kri;
